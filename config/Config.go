...
type Config struct {
	...
	BaseLogName                               string        //the base name to use for all loggers in the DHT, this is useful to provide a consistent and identifiable prefix for all log entries generated by the DHT which can aid in log filtering and analysis.
...
func GetDefaultSingletonInstance() *Config {
	if singletonConfig == nil {
		singletonConfig = &Config{
			...
			BaseLogName:                               "shareful.utils.dht",
